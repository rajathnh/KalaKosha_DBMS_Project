  ...
  return (
    <nav className="navbar" role="navigation" aria-label="Main">
      <div className="navbar-container">
        <div className="navbar-left">
          ...
          <div className="navbar-menu">
            ...
            <Link to="/products">Explore Art</Link>
        ...
        <div className="navbar-right">
          {user ? (
            <>
              <Link to={user.role === 'artist' ? `/dashboard` : '/dashboard'} className="greet-link" aria-label="View your profile">
      ...
      >
        ...
        <Link to="/products" className="mobile-nav-item" onClick={() => setIsMenuOpen(false)}>Explore Art</Link>
        <Link to="/blog" className="mobile-nav-item" onClick={() => setIsMenuOpen(false)}>Blog</Link>
        <Link to="/events" className="mobile-nav-item" onClick={() => setIsMenuOpen(false)}>Events</Link>
